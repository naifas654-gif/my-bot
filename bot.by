...
async def is_reply_to_pinned(update: Update, context: ContextTypes.DEFAULT_TYPE):
...
async def main():
    ...
    application.add_handler(CommandHandler("start_dist", start_dist))
    application.add_handler(CommandHandler("stop_dist", stop_dist))
